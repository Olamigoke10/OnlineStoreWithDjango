...
SECRET_KEY = 'django-insecure-^-ks70#vq0@md%jfc8syj@6qn(825q#03ptupqfalq-+owh4o_'
...
EMAIL_PORT = 465  # Your SMTP port (587 for TLS)
EMAIL_USE_SSL = True
EMAIL_USE_TLS = False  # True if your SMTP server requires TLS
